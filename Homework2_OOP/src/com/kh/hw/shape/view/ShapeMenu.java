...
public class ShapeMenu {
	...
	public void inputSize(int type, int menuNum) {
		if(type==3&& menuNum==1) {
			...
			System.out.print("면적 : "+ tc.calcArea(3, 1) );
		...
		if(type==4&&menuNum==1) {
			...
			System.out.println("사각형 둘레 : "+ scr.calcArea(4, 2));
		}
		if(type==4&&menuNum==2) {
			System.out.println("높이 : ");
			int sheight=sc.nextInt();
			System.out.println("너비 : ");
			int swidth=sc.nextInt();
			System.out.println("사각형 면적: "+ scr.calcArea(4, 1));
