...
public class FileRun {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//3.폴더만 생성하기
			File bbbFolder =  new File("C:/bbb");//폴더 하나만 만들어줌 
			bbbFolder.mkdir();
			//File file3= new File()
			...
			//폴더가 임 존재하는지 체크, 존재하지 않는다면 폴더 생성
			if(!aaa.exists()) {
				aaa.mkdir();
			}
			file2.createNewFile();
